...
public class ProfessorController {
  ...
  private final RegisterProfessorControllerMapper mapper = Mappers.getMapper(RegisterProfessorControllerMapper.class);
  private final ProfessorDocumentMapper professorDocumentMapper = Mappers.getMapper(ProfessorDocumentMapper.class);
  ...
  public ResponseEntity<ProfessorResponse> registerProfessor(
    ...
    ProfessorDocument professorDocument = commandGateway.invoke(RegisterProfessor.class, mapper.map(request, collegeDocument, courseDocument, disciplineDocument));
  ...
  public ResponseEntity<ProfessorResponse> findProfessorById(
    ...
    ProfessorDocument professorDocument = commandGateway.invoke(
            ...
            FindProfessorById.Request.builder().id(id).build());
  ...
  public ResponseEntity<Page<ProfessorResponse>> findAllProfessorByDiscplineCourseAndFaculdadeId(
    ...
    Page<ProfessorResponse> professorResponses = commandGateway.invoke(
