...
public class FindAllProfessorAnalysisReceiver
    extends AbstractReceiver<FindAllProfessorAnalysis.Request, Page<ProfessorAnaliseResponse>> {
  ...
  @Override
  protected Page<ProfessorAnaliseResponse> doExecute(FindAllProfessorAnalysis.Request parameter) {
