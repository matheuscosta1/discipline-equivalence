...
INSERT INTO curso (nome, faculdade_id) VALUES
    ('Matemática', 2),
    ('Sistemas de Informação', 1),
    ('Ciência da Computação', 1);

INSERT INTO disciplina (nome, codigo_origem, ementa, programa, carga_horaria, faculdade_id, curso_id) VALUES
...
INSERT INTO professor (nome, faculdade_id, curso_id, disciplina_id, usuario_id, status) VALUES
    ('Matheus Jose', 1, 2, 1, 2, 'ACTIVE');

INSERT INTO analises (data_maxima, faculdade_origem_id, curso_origem_id, disciplina_origem_id, faculdade_destino_id, curso_destino_id, disciplina_destino_id, professor_id, admin_user_id, status, nome_aluno, email_aluno) VALUES
